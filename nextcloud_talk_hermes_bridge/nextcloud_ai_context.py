...
small, bounded context packet from Nextcloud before Hermes is invoked. The first
backend is deterministic file search via Nextcloud's OCS search endpoint; later
backends can call Assistant/Context Chat without changing the bridge seam.
"""
